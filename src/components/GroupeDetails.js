  ...
  return (
    <div>
      ...
      <div className="relative">
        <img src={Image} alt="Bannière" className="w-full h-72 object-cover" />
      </div>
      ...
      <div className="max-w-lg mx-auto p-6 bg-white rounded-lg shadow-2xl mt-20 z-10 mb-20">
        ...
        <p className="text-gray-700 mb-2">
          <strong>Description :</strong> {concert.description || "Aucune description fournie"}
        </p>

        <div className="mb-4">
          <p className="flex items-center">
            <FaMoneyBillWave className="mr-2 text-green-600" />
            <strong>Coût :</strong> {concert.price ? concert.price : "Non spécifié"}
          </p>
          <p className="flex items-center">
            <FaMapMarkerAlt className="mr-2 text-blue-600" />
            <strong>Lieu :</strong> {concert.lieu ? concert.lieu.name : "Non spécifié"}
          </p>
          <p className="flex items-center">
        ...
        <p className="text-gray-500">
          ...
          {concert.start_date ? new Date(concert.start_date).toLocaleString() : "Non spécifiée"}
        </p>
        <p className="text-gray-500">
          <strong>Date de fin :</strong>{" "}
          {concert.end_date ? new Date(concert.end_date).toLocaleString() : "Non spécifiée"}
        </p>
